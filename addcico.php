...
<body>
	...
	<h1>Welcome To Online Room Reservation</h1>
...
<br>
   		...
   		<table>
   			<tr>
				...
				<th style="display: none;">
					<input type="checkbox" name="booked" value="booked" required checked="checked">Check this to ensure this is an online booking.
				</th>
			</tr>
   		...
   		<table>
   			<tr>
				...
				<th style="display: none;">
					<input type="checkbox" name="restype" value="1" required checked="checked">I will accept the alterations in the charges & taxes during the stay.
				</th>
			</tr>
