...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "f1")) {
  $insertSQL = sprintf("INSERT INTO cus_details (First_Name) VALUES (%s)",
...
$Recordset1 = mysql_query($query_Recordset1, $localhost4) or die(mysql_error());
    ...
    <div class="w3-row w3-padding-32">
      ...
      <div class="w3-third">
        ...
        <table width="352" border="1">
          <tr>
            <td><form action="<?php echo $editFormAction; ?>" method="POST" name="f1" id="f1">
              <table border="1" align="center">
                <tr>
                  <td><input type="submit" name="b1" id="b1" value="Submit"></td>
                  <td><span id="sprytextfield1">
                    <label for="f1"></label>
                    <input type="text" name="f2" id="f1">
        ...
        <table width="352" border="1">
          <tr>
            <td><?php if ($totalRows_Recordset1 > 0) { // Show if recordset not empty ?>
                <?php do { ?>
                  <table width="156" border="1" align="center">
                    <tr>
                      <td><?php echo $row_Recordset1['PageName']; ?></td>
                      <td><a href="e2.php">Edit Page Content</a></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td><form action="" method="post" name="brt" id="brt">
