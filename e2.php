...
$query_Recordset1 = sprintf("SELECT * FROM pages WHERE ID = %s", GetSQLValueString($colname_Recordset1, "int"));
              ...
              <table width="156" border="1">
                ...
                <tr>
                  <td><span id="sprytextarea1">
                    <label for="t1"></label>
                    <textarea name="t1" id="t1" cols="45" rows="5"><?php echo $row_Recordset1['PageContent']; ?></textarea>
                ...
                <tr>
                  <td><input type="submit" name="b3" id="b3" value="Submit"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                </tr>
