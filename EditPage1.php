...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "EditPageForm")) {
  $updateSQL = sprintf("UPDATE pages1 SET PageContent=%s WHERE ID=%s",
...
mysql_select_db($database_localhost, $localhost);
$query_EditPage = sprintf("SELECT * FROM pages1 WHERE ID = %s", GetSQLValueString($colname_EditPage, "int"));
$EditPage = mysql_query($query_EditPage, $localhost) or die(mysql_error());
