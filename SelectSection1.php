...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "SelectSectionForm")) {
  $insertSQL = sprintf("INSERT INTO pages1 (PageName) VALUES (%s)",
                       GetSQLValueString($_POST['NewSection'], "text"));

  mysql_select_db($database_localhost, $localhost);
  $Result1 = mysql_query($insertSQL, $localhost) or die(mysql_error());

  $insertGoTo = "SelectSection1.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_localhost, $localhost);
$query_pages = "SELECT * FROM pages1";
$pages = mysql_query($query_pages, $localhost) or die(mysql_error());
...
<div class="w3-content w3-text-grey" style="max-width:2000px; margin-top:0px">
  ...
  <div class="mySlides w3-display-container w3-center  ">
    <img src="Images/fb1.jpg" style="width:100%">
            ...
            <td><form action="<?php echo $editFormAction; ?>" method="POST" name="SelectSectionForm" id="SelectSectionForm">
              <table border="1" align="center">
                <tr>
                  ...
                  <td><input type="submit" name="SelectSectionButton" id="SelectSectionButton" value="Select Section"></td>
                </tr>
              </table>
                ...
                <?php do { ?>
                  <table width="271" border="1" align="center">
                    <tr>
                      ...
                      <td width="131"><a href="EditPage1.php?ID=<?php echo $row_pages['ID']; ?>">Edit Page Content</a></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
