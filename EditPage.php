...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "EditPageForm")) {
  $updateSQL = sprintf("UPDATE pages SET PageContent=%s WHERE ID=%s",
  ...
  $Result1 = mysql_query($updateSQL, $localhost1) or die(mysql_error());

  $updateGoTo = "SelectSection.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$EditPage = mysql_query($query_EditPage, $localhost1) or die(mysql_error());
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="login.html" class= "w3-padding-large w3-hover-red w3-hide-small w3-right">LOGIN</a>
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:1100px" id="packages">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-third">
          ...
          <tr>
            <td><form action="<?php echo $editFormAction; ?>" method="POST" name="EditPageForm" id="EditPageForm">
              <table width="150" border="1" align="center">
                <tr>
                  <td height="114"><span id="sprytextarea1">
        ...
        <p>&nbsp;</p>
        <p><a href="addcico.php" class="w3-hover-red" style="display: none;">More</a></p>
      </div>
      <div class="w3-third">
