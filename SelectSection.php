...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "AddPagesForm")) {
  ...
  $Result1 = mysql_query($insertSQL, $localhost1) or die(mysql_error());

  $insertGoTo = "SelectSection.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if ((isset($_POST['DeletePagehiddenField'])) && ($_POST['DeletePagehiddenField'] != "")) {
  ...
  mysql_select_db($database_localhost1, $localhost1);
  $Result1 = mysql_query($deleteSQL, $localhost1) or die(mysql_error());

  $deleteGoTo = "SelectSection.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$pages = mysql_query($query_pages, $localhost1) or die(mysql_error());
...
<div class="w3-content w3-text-grey" style="max-width:2000px; margin-top:46px">
  ...
  <div class="mySlides w3-display-container w3-center  ">
    <img src="Images/R11.jpg" style="width:100%">
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:1100px" id="packages">
    ...
    <p class="w3-opacity"><i>Make sure to select the best that suits you</i></p>
  </br>
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-third">
        ...
        <table width="332" border="1" align="center">
          <tr>
            <td><form action="<?php echo $editFormAction; ?>" method="POST" name="AddPagesForm" id="AddPagesForm">
                ...
                <?php do { ?>
                  <table width="269" border="1" align="center">
                    <tr>
                      ...
                      <td width="129"><a href="EditPage.php?ID=<?php echo $row_pages['ID']; ?>">Edit Page Content</a></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td><form action="" method="post" name="DeletePageForm" id="DeletePageForm">
                        <input name="DeletePagehiddenField" type="hidden" id="DeletePagehiddenField" value="<?php echo $row_pages['ID']; ?>">
                        <input type="submit" name="DeletePageButton" id="DeletePageButton" value="Delete Section">
                      </form></td>
                    </tr>
                  </table>
