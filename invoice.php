  ...
  { 
    ...
    $statement = $connect->prepare("
      INSERT INTO tbl_order 
        (order_no, order_date, order_receiver_name, order_receiver_address, order_total_before_tax, order_total_tax, order_total_after_tax, order_datetime)
        VALUES (:order_no, :order_date, :order_receiver_name, :order_receiver_address, :order_total_before_tax, :order_total_tax, :order_total_after_tax, :order_datetime)
    ");
    $statement->execute(
      array(
      ...
      for($count=0; $count<$_POST["total_item"]; $count++)
      {
        ...
        $order_total_tax = $order_total_tax + floatval(trim($_POST["order_item_tax_amount"][$count]));

        $order_total_after_tax = $order_total_after_tax + floatval(trim($_POST["order_item_final_amount"][$count]));

        $statement = $connect->prepare("
          INSERT INTO tbl_order_item 
          (order_id, item_name, order_item_quantity, order_item_price, order_item_actual_amount, order_item_tax_rate, order_item_tax_amount, order_item_final_amount)
          VALUES (:order_id, :item_name, :order_item_quantity, :order_item_price, :order_item_actual_amount, :order_item_tax_rate, :order_item_tax_amount, :order_item_final_amount)
        ");
        ...
        $statement->execute(
          array(
            ...
            ':order_item_tax_rate'         =>  trim($_POST["order_item_tax_rate"][$count]),
            ':order_item_tax_amount'       =>  trim($_POST["order_item_tax_amount"][$count]),
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <form method="post" id="invoice_form">
        <div id="div1" class="table-responsive"> <button onclick="printContent('div1')">
        Print Invoice</button>
          <table class="table table-bordered">
            <tr>
              <td colspan="2" align="center"><h2 style="margin-top:10.5px">Invoice - Tanzanite Beach View Hotel</h2></td>
            </tr>
            <tr>
                <td colspan="2">
                  <div class="row">
                  ...
                  <table id="invoice-item-table" class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="order_item_tax_rate[]" id="order_item_tax_rate1" data-srno="1" class="form-control input-sm number_only order_item_tax_rate" /></td>
                      <td><input type="text" name="order_item_tax_amount[]" id="order_item_tax_amount1" data-srno="1" readonly class="form-control input-sm order_item_tax_amount" /></td>
      ...
      $(document).ready(function(){
        ...
        $(document).on('click', '#add_row', function(){
          ...
          html_code += '<td><input type="text" name="order_item_tax_rate[]" id="order_item_tax_rate'+count+'" data-srno="'+count+'" class="form-control input-sm number_only order_item_tax_rate" /></td>';
          html_code += '<td><input type="text" name="order_item_tax_amount[]" id="order_item_tax_amount'+count+'" data-srno="'+count+'" readonly class="form-control input-sm order_item_tax_amount" /></td>';
          ...
          for(j=1; j<=count; j++)
          {
            ...
            if(quantity > 0)
            {
              ...
              if(price > 0)
              {
                ...
                tax_rate = $('#order_item_tax_rate'+j).val();
                if(tax_rate > 0)
                {
                  tax_amount = parseFloat(actual_amount)*parseFloat(tax_rate)/100;
                  $('#order_item_tax_amount'+j).val(tax_amount);
                }
                ...
                <td colspan="2">
                  ...
                  <table id="invoice-item-table" class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="order_item_tax_rate[]" id="order_item_tax_rate<?php echo $m; ?>" data-srno="<?php echo $m; ?>" class="form-control input-sm number_only order_item_tax_rate" value="<?php echo $sub_row["order_item_tax_rate"]; ?>" /></td>
                      <td><input type="text" name="order_item_tax_amount[]" id="order_item_tax_amount<?php echo $m; ?>" data-srno="<?php echo $m; ?>" readonly class="form-control input-sm order_item_tax_amount" value="<?php echo $sub_row["order_item_tax_amount"];?>" /></td>
          ...
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td style = "display:none;"><a href="print_invoice.php?pdf=1&id='.$row["order_id"].'">PDF</a></td>
    ...
    <br>
    <!--
   <footer class="container-fluid text-center print" style="bottom: 0;">
